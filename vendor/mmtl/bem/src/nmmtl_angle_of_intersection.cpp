...
/*
  ...
  double x1, y1   x and y displacement of first line segment
  double x2, y2   x and y displacement of second line segment
...
double nmmtl_angle_of_intersection(double x1, double y1, double x2, double y2)
{
  /* tnt-web patch: originally acos(dot/(len1*len2)) with the sign taken
     ...
     and double/double overload resolution; callers guard the straight-line
